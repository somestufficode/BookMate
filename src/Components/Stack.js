...
import Animated, { useSharedValue, useAnimatedGestureHandler, useAnimatedStyle, useDerivedValue, withSpring, withTiming, interpolate, runOnJS } from 'react-native-reanimated';

const ROTATION_ANGLE = 60;
const SWIPE_VELOCITY = 800;

function Stack({ data, renderItem, onSwipeRight, onSwipeLeft }) {
